...
type Repository struct {
	...
	eventsCache map[string][]audit.Event
}
...
func New(root string) (*Repository, error) {
	...
	repo := &Repository{root: root, clock: time.Now, eventsCache: map[string][]audit.Event{}}
